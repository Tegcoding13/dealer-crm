          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 bg-gray-100 rounded-xl p-1">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors bg-[#367C2B] text-white hover:bg-[#2d6824] disabled:opacity-40 disabled:cursor-not-allowed"
              >
              ...
              <a
                ...
                title={lead.phone ? `Text ${lead.phone}` : 'No phone number'}
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${lead.phone ? 'text-blue-600 hover:bg-blue-50 cursor-pointer' : 'text-gray-300 cursor-not-allowed'}`}
              >
              ...
              <a
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${lead.email ? 'text-purple-600 hover:bg-purple-50 cursor-pointer' : 'text-gray-300 cursor-not-allowed'}`}
              >

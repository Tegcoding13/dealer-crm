...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Demo banner */}
      <div className="bg-[#367C2B] text-white text-sm py-2 px-4 flex items-center justify-between">
        <span className="font-medium">👋 You&apos;re viewing a demo of IronFlowCRM</span>
        <Link href="/" className="bg-white text-[#367C2B] text-xs font-semibold px-3 py-1 rounded-full hover:bg-gray-100">
          Sign In →
        </Link>
      </div>
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside className="w-56 bg-[#367C2B] flex flex-col shrink-0">
